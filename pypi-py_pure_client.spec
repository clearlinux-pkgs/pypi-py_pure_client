...
Version  : 1.22.0
Release  : 1
URL      : https://github.com/PureStorage-OpenConnect/py-pure-client/archive/1.22.0.tar.gz
Source0  : https://github.com/PureStorage-OpenConnect/py-pure-client/archive/1.22.0.tar.gz
...
%prep
%setup -q -n py-pure-client-1.22.0
cd %{_builddir}/py-pure-client-1.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641931363
...
cp %{_builddir}/py-pure-client-1.22.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-py_pure_client/2b874e6b1e7f063ef687afd4395bdd1263ac700f
